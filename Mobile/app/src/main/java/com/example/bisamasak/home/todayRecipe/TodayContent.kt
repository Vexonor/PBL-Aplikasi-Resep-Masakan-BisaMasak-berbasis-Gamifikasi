...
@Composable
fun TodayContent(navController: NavController, windowSize: WindowSizeClass, userLevel: Int) {
        ...
        Surface(
            ...
            if (isLoading) {
                ...
                if (recipe.isNotEmpty()) {
                    val sortedRecipes = recipe.sortedBy { it.terbuka_di_level }
                    when(windowSize.widthSizeClass) {
                        WindowWidthSizeClass.Compact -> {
                            Portrait(sortedRecipes, onRecipeClick, userLevel)
                        }
                        WindowWidthSizeClass.Expanded -> {
                            Landscape(sortedRecipes, onRecipeClick, userLevel)
                        }
                    }
                } else {
                    Text(
