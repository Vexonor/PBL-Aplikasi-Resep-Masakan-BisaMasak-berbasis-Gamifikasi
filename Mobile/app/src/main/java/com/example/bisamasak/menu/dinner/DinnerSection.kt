    ...
    Column (
        ...
        when(windowSize.widthSizeClass) {
            WindowWidthSizeClass.Compact -> {
                PortraitDinner(recipes, onRecipeClick)
            }
            WindowWidthSizeClass.Expanded -> {
                LandscapeDinner(recipes, onRecipeClick)
            }
        }
    }
}
...
@Composable
fun PortraitDinner(recipes: List<Recipe>, onRecipeClick: (Int) -> Unit) {
...
@Composable
fun LandscapeDinner(recipes: List<Recipe>, onRecipeClick: (Int) -> Unit) {
