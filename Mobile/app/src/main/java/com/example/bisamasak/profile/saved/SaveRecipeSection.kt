    ...
    Column (
        ...
        when(windowSize.widthSizeClass) {
            WindowWidthSizeClass.Compact -> {
                PortraitSaveRecipeSection()
            }
            WindowWidthSizeClass.Expanded -> {
                LandscapeSaveRecipeSection()
            }
        }
    }
}
...
@Composable
fun PortraitSaveRecipeSection() {
    val randomRecipes = rememberSaveable {
        DataProvider.ResepSimpan.shuffled().take(2)
    }
    Row (
        modifier = Modifier
            .fillMaxWidth(),
...
@Composable
fun LandscapeSaveRecipeSection() {
    val randomRecipes = rememberSaveable {
        DataProvider.ResepSimpan.shuffled().take(4)
    }
    Row (
        modifier = Modifier
            .fillMaxWidth(),
