<form action="" class="flex flex-col gap-4 p-5" method="post" enctype="multipart/form-data">
    ...
    <!-- Input Ingredient -->
    <div class="flex flex-col gap-2" id="textInputContainerIngredient">
        <label for="input-ingredient" class="block text-sm font-medium mb-2 w-full">Bahan Masak</label>
        <div class="flex flex-wrap gap-2">
            <div class="flex-2">
                <label for="input-ingredient" class="block text-sm font-medium mb-2">Nama Bahan</label>
    ...
    <div class="w-full">
        ...
        <input type="file" name="file-input" id="input-thumbnail"
            class="block w-full border border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none file:bg-cinnabar file:text-white file:border-0 file:me-4 file:py-3 file:px-4">
    </div>
    <!-- Upload Video -->
    <div class="w-full">
        <label for="input-video" class="block text-sm font-medium mb-2">Video Tutorial</label>
        <input type="file" name="file-input" id="input-video"
            class="block w-full border border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none file:bg-cinnabar file:text-white file:border-0 file:me-4 file:py-3 file:px-4">
    </div>
    <!-- Submit Button -->
