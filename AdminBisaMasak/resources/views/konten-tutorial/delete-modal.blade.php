...
<div id="popup-modal{{ $resep -> id_resep }}" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-lg max-h-full">
        <div class="relative bg-alabaster rounded-lg shadow-xl">
            <button type="button"
                ...
                data-modal-hide="popup-modal{{ $resep -> id_resep }}">
            ...
            <div class="p-4 md:p-5 text-center text-charcoal">
                ...
                <form action="{{ route('konten-tutorial.destroy', $resep -> id_resep) }}" method="post"
                    ...
                    <button data-modal-hide="popup-modal{{ $resep -> id_resep }}" type="button"
