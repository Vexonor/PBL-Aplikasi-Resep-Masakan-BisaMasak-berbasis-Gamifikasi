...
<div id="popup-modal{{ $laporan -> id_laporan }}" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-lg max-h-full">
        <div class="relative bg-alabaster rounded-lg shadow-xl">
            <button type="button"
                ...
                data-modal-hide="popup-modal{{ $laporan -> id_laporan }}">
            ...
            <div class="p-4 md:p-5 text-center text-charcoal">
                ...
                <form action="{{ route('laporan-konten.update', $laporan -> id_laporan) }}" method="post"
                    ...
                    <button data-modal-hide="popup-modal{{ $laporan -> id_laporan }}" type="button"
