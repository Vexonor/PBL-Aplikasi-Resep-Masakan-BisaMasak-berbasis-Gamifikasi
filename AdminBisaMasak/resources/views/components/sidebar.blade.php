        ...
        <nav
            ...
            <div class=" pb-0 px-2  w-full flex flex-col flex-wrap">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ $title == 'Konfirmasi Konten' || $title == 'Detail Konten Resep' ? 'bg-cinnabar text-white' : 'text-charcoal hover:bg-cinnabar/50' }} rounded-lg focus:outline-hidden"
                    ...
                    <!-- Report Content -->
                    <li>
                        <a class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ $title == 'Laporan Konten' || $title == 'Detail Konten Laporan' || $title == 'Detail Laporan' ? 'bg-cinnabar text-white' : 'text-charcoal hover:bg-cinnabar/50' }} rounded-lg focus:outline-hidden"
                            href="/laporan-konten">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor"
                                viewBox="0 0 256 256">
                                <path
