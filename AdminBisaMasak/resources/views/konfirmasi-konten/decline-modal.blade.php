...
<div id="popup-modal-decline{{ $resep -> id_resep }}" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-lg max-h-full">
        <div class="relative bg-alabaster rounded-lg shadow-xl">
            <button type="button"
                ...
                data-modal-hide="popup-modal-decline{{ $resep -> id_resep }}">
            ...
            <div class="p-4 md:p-5 text-center text-charcoal">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500">
                    Apakah kamu yakin ingin memblokir konten ini?
                </h3>
                <form action="{{ route('konfirmasi-konten.destroy', $resep -> id_resep) }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    @method('DELETE')
                    <button data-modal-hide="popup-modal-decline" type="submit"
                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Ya
                    </button>
                    <button data-modal-hide="popup-modal-decline{{ $resep -> id_resep }}" type="button"
