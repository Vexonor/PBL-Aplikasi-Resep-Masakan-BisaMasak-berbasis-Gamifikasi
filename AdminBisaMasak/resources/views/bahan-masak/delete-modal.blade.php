...
<div id="popup-modal{{ $bahanMasak -> id_bahan }}" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-lg max-h-full">
        <div class="relative bg-alabaster rounded-lg shadow-xl">
            <button type="button"
                ...
                data-modal-hide="popup-modal{{ $bahanMasak -> id_bahan }}">
            ...
            <div class="p-4 md:p-5 text-center text-charcoal">
                ...
                <form action="{{ route('bahan-masak.destroy', $bahanMasak -> id_bahan) }}" method="post"
                    ...
                    <button data-modal-hide="popup-modal{{ $bahanMasak -> id_bahan }}" type="button"
